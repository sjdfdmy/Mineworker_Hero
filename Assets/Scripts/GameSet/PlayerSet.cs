...
public class PlayerSet : MonoBehaviour
{
    ...
    private Button setbtn;//场景内设置按钮
    private Slider totalvolumnslider;//总音量滑动条
    private Slider volumnslider;//背景音乐滑动条
    private Slider voiceeffectslider;//音效滑动条
    private Button istotalvolumnbutton;//总音量一键静音按钮
    private Button isvolumnbutton;//背景音乐一键静音按钮
    private Button isvoiceeffectbutton;//音效一键静音按钮
